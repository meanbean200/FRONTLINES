...
export interface PreparedOrder {squadId:number;intent:TacticalIntent;target:Vec2;networkId?:number;preparedAt:number;signalAt?:number;releasedAt?:number}
