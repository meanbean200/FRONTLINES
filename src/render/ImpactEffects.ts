...
export class ImpactEffects {
  ...
  update(state:BattlefieldState,terrain:TerrainSystem):void{
    ...
    for(const b of op?.blastEvents??[])if(now-b.at<1&&visible(b))remember({key:`b${b.id}`,id:b.id,at:b.at,x:b.x,y:terrain.heightAt(b.x,b.z)+.15,z:b.z,blast:true,stone:false});
