...
scope.onmessage=({data:r})=>{
  ...
  const result:GroundResponse={id:r.id,generationMs:performance.now()-begin,position:geometry.attributes.position.array as Float32Array,normal:geometry.attributes.normal.array as Float32Array,color:geometry.attributes.color.array as Float32Array,groundCover:geometry.attributes.groundCover.array as Float32Array,index:geometry.index!.array as Uint16Array|Uint32Array};
