...
it('estimates remaining travel, recovery and only actual carried endurance without mutation',()=>{
  ...
  for(const person of s.soldiers.filter(person=>person.squadId===q.id)){person.needs!.energy=24;person.needs!.hunger=90;person.carried!.food=0;person.carried!.water=0;}
