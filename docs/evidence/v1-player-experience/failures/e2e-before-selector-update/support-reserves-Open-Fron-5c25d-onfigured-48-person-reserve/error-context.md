...
- Name: support-reserves.spec.ts >> Open Front shows the configured 48-person reserve
...
Expected substring: "Reserve 48/48"
...
Call log:
  ...
  - waiting for locator('.support-status')
    13 × locator resolved to <div class="support-status">…</div>
