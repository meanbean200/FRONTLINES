...
- Name: support-reserves.spec.ts >> Open Front shows the configured 24-person reserve
...
Expected substring: "Reserve 24/24"
...
Call log:
  ...
  - waiting for locator('.support-status')
    14 × locator resolved to <div class="support-status">…</div>
