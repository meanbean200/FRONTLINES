async(page)=>{
  ...
  await page.setViewportSize({width:1920,height:1080});await page.reload();await page.locator('#choose-operation').click();
  ...
  await page.locator('.hud-tools>summary').click();await page.locator('#open-build').click();const build=await page.locator('#build-panel').innerText();await page.screenshot({path:out+'build.png'});await page.locator('[data-build-close]').click();
